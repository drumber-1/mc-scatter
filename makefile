...
OBJS_NAMES = main.o para.o random.o grid.o photon.o image.o util.o fileio.o fileio_mg.o fileio_lua.o console.o mcscatter.o log.o lua.o config.o command.o
